...
public class FragmentHeating2 extends Fragment implements SeekBar.OnSeekBarChangeListener {
    ...
    private void initView(View view) {
        ...
        mRefAC = database.getReference("SmartHome").child(FirebaseAuth.getInstance().getUid()).child("LivingRoom")
               .child("AC");
        mRefHeating = database.getReference("SmartHome").child(FirebaseAuth.getInstance().getUid()).child("LivingRoom")
               .child("Heating");
        ...
        mSwitchHeating.setOnClickListener(view1 -> {
            if (mSwitchHeating.isChecked()) {
                ...
                PopUpClass popUpClass = new PopUpClass();
                popUpClass.showPopupWindow(view1, "Heating OFF");
