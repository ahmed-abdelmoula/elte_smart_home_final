...
public class FragmentHeatingBathroom extends Fragment implements SeekBar.OnSeekBarChangeListener {
    ...
    private void initView(View view) {
        ...
        mRef = database.getReference("SmartHome").child(FirebaseAuth.getInstance().getUid()).child("Bathroom");


        mRefAC = database.getReference("SmartHome").child(FirebaseAuth.getInstance().getUid()).child("Bathroom")
               .child("AC");
        mRefHeating = database.getReference("SmartHome").child(FirebaseAuth.getInstance().getUid()).child("Bathroom")
               .child("Heating");
