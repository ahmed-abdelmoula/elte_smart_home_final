...
public class FragmentBedRoomPlugIn extends Fragment {
    ...
    private long twohour = 7_200_000; //two hours
...
// the very first time when the app is opened, there is nothing to show
        ...
        mRef = database.getReference("SmartHome").child(FirebaseAuth.getInstance().getUid()).child("BedRoom").child("PlugIn");
        mRefTV = database.getReference("SmartHome").child(FirebaseAuth.getInstance().getUid()).child("BedRoom")
                .child("PlugIn").child("TV");
        mRefLaptop = database.getReference("SmartHome").child(FirebaseAuth.getInstance().getUid()).child("BedRoom")
                .child("PlugIn").child("Laptop");
        mRefDesktop = database.getReference("SmartHome").child(FirebaseAuth.getInstance().getUid()).child("BedRoom")
        ...
        mSwitchLapTop.setOnClickListener(view1 -> {
            if (mSwitchLapTop.isChecked()) {
                ...
                PopUpClass popUpClass = new PopUpClass();
                popUpClass.showPopupWindow(view1,"Laptop is opened");
            } else {
                ...
                PopUpClass popUpClass = new PopUpClass();
                popUpClass.showPopupWindow(view1,"Laptop is closed");
        ...
        mDesktop.setOnClickListener(view1 -> {
            if (mDesktop.isChecked()) {
                ...
                PopUpClass popUpClass = new PopUpClass();
                popUpClass.showPopupWindow(view1,"Desktop is opened");
            } else {
                ...
                PopUpClass popUpClass = new PopUpClass();
                popUpClass.showPopupWindow(view1,"Desktop is closed");
